...
for indx,item in sbshtrain.iterrows():
        shtrain_set.insert({"data":indx,"open":item['open'],"close":item['close'],"volume":item['volume'],"high":item['high'],"low":item['low']})  
sbshtest = ts.get_k_data("000001",start= "2013-01-01",end= '2018-10-01')
shtest_set = db['000001test']
for indx,item in sbshtest.iterrows():
        shtest_set.insert({"data":indx,"open":item['open'],"close":item['close'],"volume":item['volume'],"high":item['high'],"low":item['low']}) 
...
for indx,item in sbsztrain.iterrows():
        sztrain_set.insert({"data":indx,"open":item['open'],"close":item['close'],"volume":item['volume'],"high":item['high'],"low":item['low']}) 
sbsztest = ts.get_k_data("399001",start= "2013-01-01",end= '2018-10-01')
sztest_set = db['399001test']
for indx,item in sbsztest.iterrows():
        sztest_set.insert({"data":indx,"open":item['open'],"close":item['close'],"volume":item['volume'],"high":item['high'],"low":item['low']}) 
